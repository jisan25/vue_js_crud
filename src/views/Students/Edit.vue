    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button @click="updateStudent" type="button" class="btn btn-primary">Save</button>
                </div>
            </div>
        </div>
    </div>
...
export default{
    ...
    methods:{
        getStudentData(id){
            axios.get(`http://127.0.0.1:8000/api/students/edit/${id}`)
            .then(res=>{
        ...
        updateStudent(){
         ...
         axios.put(`http://127.0.0.1:8000/api/students/update/${id}`, this.model.student)
         .then(res=>{
